...
public class TableMainLayout extends RelativeLayout {
    ...
    private void generateTableC_AndTable_B(){
        ...
        for(int x=0; x<this.headerCellsWidth.length; x++){
            ...
            for (int j = 0; j< 48; j++) {
                TableRow tableRowForTableC = this.tableRowForTableC(sampleObjects.get(j),j);
                TableRow taleRowForTableD = this.taleRowForTableD(sampleObjects.get(j));
    ...
    TableRow tableRowForTableC(SampleObject sampleObject, int headerPosition){

        TableRow.LayoutParams params = new TableRow.LayoutParams( this.headerCellsWidth[0],LayoutParams.MATCH_PARENT);
        params.setMargins(0, 2, 0, 0);

        TableRow tableRowForTableC = new TableRow(this.context);
        TextView textView1 = this.bodyTextView(sampleObject.getHeader(headerPosition));
        ...
        String info[] = {
            //  sampleObject.header1,
               ...
               /* sampleObject.array[0],
                ...
                sampleObject.array[4],
                sampleObject.array[5],
                sampleObject.array[6],
                sampleObject.array[7]*/
        };
